    ...
    return Scaffold(
      ...
      body: GestureDetector(
        ...
        child: Container(
          ...
          color: const Color.fromARGB(255, 133, 158, 202), // Asegurarse de que el fondo cubra toda la pantalla
          child: Center(
...
class _QuizScreenState extends State<QuizScreen> {
  ...
  final List<Map<String, dynamic>> questions = [
    {
      "question": "1. Cual fue la primera comida que comapartimos juntos?",
      "options": ["El club de la milanesa", "La muzza", "Mc Donalds", "Barley"],
      "answer": "Mc Donalds",
      "type": "opcionesMultiples",
      "questionImage": null,
      "image": "assets/chile-nieve.jpg",
      "correctMessage": "¡Correcto! Todo empezo en el mc de guemes. Vos no te terminaste la hamburguesa",
      "incorrectMessage": "Incorrecto... fuimos al mc. Arrancamos mal",
    },
    {
      "question": "2. En que año viajamos a Chile?",
    ...
    {
      "question": "2. En que cerro de Chile comimos el mote con huesillo?",
      "options": ["Cerro Santa Lucía", "Cerro San Cristóbal", "Cerro Manquehue", "Cerro Leonera"],
    ...
    {
      "question": "3. Como se llama la cancion de Camilo que arranca con 'tu debes ser ingeniera...'?",
    ...
    {
      "question": "Completa: En la final, Messi hizo __ goles.",
      "answer": "2",
      "type": "completar",
      "questionImage": "assets/messi_goles.jpg", // Imagen para la pregunta
      "image": "assets/messi_completando.jpg", // Imagen para la respuesta
      "correctMessage": "¡Correcto! Messi hizo 2 goles.",
      "incorrectMessage": "Incorrecto... La respuesta correcta es: 2.",
    }
  ];
  ...
  void checkAnswer(BuildContext context, dynamic selectedAnswer) {
    ...
    // Si la pregunta es de tipo 'completar', comparamos el texto ingresado
    if (questions[questionIndex]['type'] == 'completar') {
      isCorrect =
          selectedAnswer.trim() == correct.trim(); // Comparación de texto
    } else {
      ...
      body: Center(
        child: Column(
          ...
          children: [            
            ...
            if (currentQuestion["type"] == "ordenar")
              Column(
                children: [
                  const Text("Ordena los elementos correctamente",
                      style: TextStyle(color: Colors.white)),
                  const SizedBox(height: 20),
                  ElevatedButton(
                    onPressed: () => checkAnswer(context,
                        ["Primer gol", "Segundo gol", "Tanda de penales"]),
                    child: const Text("Enviar respuesta"),
                  ),
                ],
              ),
...
class ResultScreen extends StatelessWidget {
  ...
  const ResultScreen(this.correctAnswers, {super.key});
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 20),
            Text(
              "Respondiste $correctAnswers de 3 preguntas correctamente.",
